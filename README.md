...
<!-- release-v2.3.1-inicio -->

## Destaques da versão v2.3.1

A versão `v2.3.1` mantém o painel de correções assistidas como recurso opcional e desativado por padrão, com foco em integridade, rastreabilidade e performance.
...
- checkpoints de persistência pós-aplicação e pré-exportação;
- escopo do painel simplificado para coleta individual ou coletas do lote;
- `COLETAS do lote` como lista explícita para operações em lote;
...
Script principal da versão: `monitora_campsav_alvo_global_v2.3.1.R`.

Cópias canônicas sincronizadas:

- `monitora_campsav_alvo_global_v2.3.1.R`
- `monitora_campsav_alvo_global.R`
- `MONITORA_CAMPSAV_Alvo_Global.R`
- `R/monitora_campsav_alvo_global.R`
- `releases/v2.3.1/monitora_campsav_alvo_global_v2.3.1.R`
...
- [`monitora_campsav_alvo_global_v2.3.1.R`](monitora_campsav_alvo_global_v2.3.1.R): cópia versionada da versão pública atual.
- [`releases/v2.3.0/monitora_campsav_alvo_global_v2.3.1.R`](releases/v2.3.0/monitora_campsav_alvo_global_v2.3.1.R): cópia congelada da versão pública `v2.3.0`.
...
- `monitora_campsav_alvo_global_v2.3.1.R`: cópia versionada da versão pública atual.
- `releases/v2.3.1/`: cópia congelada da versão pública `v2.3.1`.
