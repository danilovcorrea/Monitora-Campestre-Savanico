...
**v2.0.0** — Consolidação estatística, auditoria e relatório textual.
...
Uma cópia congelada da versão pública `v2.0.0` está disponível em:

[`releases/v2.0.0/monitora_campsav_alvo_global_v2.0.0.R`](releases/v2.0.0/monitora_campsav_alvo_global_v2.0.0.R)

## Principais funcionalidades da v2.0.0
...
- `releases/v2.0.0/`: cópia congelada da versão pública `v2.0.0`.
