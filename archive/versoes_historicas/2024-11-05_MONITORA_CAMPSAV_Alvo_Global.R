...
### 6 - Os gráficos gerados podem ser exportados em formato .png ou .pdf no menu "Export" na aba "gráficos";
...
### Renomeia colunas de Thiago.xlsx para compatibilidade com SISMONITORA.csv.
...
### Renomeia valores de colunas de Thiago.xlsx para compatibilidade com SISMONITORA.csv.
...
### correção de rótulos para nomes internos (erro em uma versao do xlsform, presente em algumas campanhas amostrais)
