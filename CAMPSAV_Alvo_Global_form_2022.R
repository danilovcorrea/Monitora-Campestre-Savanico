...
registros_corrig$`Selecione se a bromélia observada é: (amostragem/registro)` <-
  fifelse(str_detect(registros_corrig$`Formas de vida de plantas <span style=""color:red"">nativas:</span> (amostragem/registro)`, "bromelioide", negate = FALSE),
          word(registros_corrig$`Selecione se a bromélia observada é: (amostragem/registro)`,sep = fixed("|"),-1),
          NA_character_)
...
registros_corrig$`Selecione se a orquidea observada é: (amostragem/registro)` <- 
  fifelse(str_detect(registros_corrig$`Formas de vida de plantas <span style=""color:red"">nativas:</span> (amostragem/registro)`, "orquidea", negate = FALSE),
          word(registros_corrig$`Selecione se a orquidea observada é: (amostragem/registro)`,sep = fixed("|"),-1),
          NA_character_)
...
registros_corrig$`Selecione se a bromélia observada é: (amostragem/registro).1` <- 
  fifelse(str_detect(registros_corrig$`Formas de vida de plantas <span style=""color:red"">exóticas:</span> (amostragem/registro)`, "bromelioide", negate = FALSE),
          word(registros_corrig$`Selecione se a bromélia observada é: (amostragem/registro).1`,sep = fixed("|"),-1),
          NA_character_)
...
registros_corrig$`Selecione se a orquidea observada é: (amostragem/registro).1` <-
  fifelse(str_detect(registros_corrig$`Formas de vida de plantas <span style=""color:red"">exóticas:</span> (amostragem/registro)`, "orquidea", negate = FALSE),
          word(registros_corrig$`Selecione se a orquidea observada é: (amostragem/registro).1`,sep = fixed("|"),-1),
          NA_character_)
...
registros_corrig$`Selecione se a bromélia observada é: (amostragem/registro).2` <-
  fifelse(str_detect(registros_corrig$`Formas de vida de plantas <span style=""color:red"">secas ou mortas:</span> (amostragem/registro)`, "bromelioide", negate = FALSE),
          word(registros_corrig$`Selecione se a bromélia observada é: (amostragem/registro).2`,sep = fixed("|"),-1),
          NA_character_)
...
registros_corrig$`Selecione se a orquidea observada é: (amostragem/registro).2` <- 
  fifelse(str_detect(registros_corrig$`Formas de vida de plantas <span style=""color:red"">secas ou mortas:</span> (amostragem/registro)`, "orquidea", negate = FALSE),
          word(registros_corrig$`Selecione se a orquidea observada é: (amostragem/registro).2`,sep = fixed("|"),-1),
          NA_character_)
