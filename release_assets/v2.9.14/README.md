...
- Versão: `v2.9.14`
- Script principal: [`monitora_campsav_alvo_global_v2.9.14.R`](monitora_campsav_alvo_global_v2.9.14.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.14/`](releases/v2.9.14/)
- Notas da versão: [`RELEASE_NOTES_v2.9.14.md`](RELEASE_NOTES_v2.9.14.md)
- Release no GitHub: [v2.9.14](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.14)
...
## Destaques da v2.9.14

- A incorporação de novas COLETAs em modos `painel_incremental_*` funciona no
  R para Windows por um processo isolado autogerado, sem launcher ou arquivo
  auxiliar distribuído com o script.
- A pasta `input/novas_coletas/` é pesquisada recursivamente e aceita CSV,
  XLSX, XLS e ZIP, inclusive subpastas e ZIPs aninhados.
- Auditorias do processo isolado são preservadas antes da limpeza; COLETAs
  incompletas ou conflitantes bloqueiam o lote sem anexar linhas parciais.
- A edição de UA aceita qualquer valor contratual entre `UA-001_VgCS` e
  `UA-999_VgCS`, inclusive valores ainda não observados na base, com validação
  equivalente na interface e no servidor.
- Com a incorporação opcional desligada, o retorno ocorre antes de listar,
  ler, processar ou escrever arquivos.
- A inicialização rápida foi preservada e confirmada em teste real no RStudio
  para Windows, sem regressão material frente à v2.9.13.
...
Os padrões da v2.9.14 representam a continuidade incremental integral usada pela
...
2. Copie `monitora_campsav_alvo_global_v2.9.14.R` para a raiz.
...
5. Execute no RStudio ou com `Rscript monitora_campsav_alvo_global_v2.9.14.R`.
...
A v2.9.14 preserva os 13 modos públicos:
...
- `monitora_campsav_alvo_global_v2.9.14.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.14.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.14.md`: roteiro operacional resumido.
- `release_assets/v2.9.14/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.14/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.14. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.14. Acesso em: DD mês AAAA.
```
