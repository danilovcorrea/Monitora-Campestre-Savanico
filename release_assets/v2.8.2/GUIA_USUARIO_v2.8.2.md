# Guia do usuário — v2.8.2

## Preparação

1. Crie uma pasta de execução vazia.
2. Copie `monitora_campsav_alvo_global_v2.8.2.R` para essa pasta.
...
A planilha exige um único contexto de UC, ciclo e campanha e exatamente 101
pontos por coleta. As colunas `uuid` e `amostragem/registro/uuid` continuam
presentes, mas todas as células de dados ficam vazias para que o SISMONITORA
gere identidades novas. Não preencha esses UUIDs e não use esse produto para
