...
- Versão: `v2.5.2`
- Script principal versionado: [`monitora_campsav_alvo_global_v2.5.2.R`](monitora_campsav_alvo_global_v2.5.2.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada no repositório: [`releases/v2.5.2/monitora_campsav_alvo_global_v2.5.2.R`](releases/v2.5.2/monitora_campsav_alvo_global_v2.5.2.R)
...
- [`monitora_campsav_alvo_global_v2.5.2.R`](monitora_campsav_alvo_global_v2.5.2.R): cópia versionada da versão pública atual.
