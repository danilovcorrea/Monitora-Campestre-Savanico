# Guia do usuário — v2.9.25

## Preparação

1. Crie uma pasta de execução vazia.
2. Copie `monitora_campsav_alvo_global_v2.9.25.R` para essa pasta.
...
## Novidades operacionais da v2.9.25
...
- Para gerar o projeto QField, use `MONITORA_OPCAO_GERAR_PROJETO_QFIELD = "S"`
  ...
  `MONITORA_OPCAO_IMPORTAR_CAMADAS_QFIELD = "S"`. Coloque um MBTiles detalhado
  diretamente em `qfield_entrada/<uc_normalizada>/`; os demais formatos e
...
- O relatório de validação separa arquivos atuais e herdados, modificações do
  bolsista, modificações automáticas e registros estritamente técnicos de
