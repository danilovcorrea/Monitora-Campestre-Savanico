...
- Versão: `v2.7.1`
- Script principal: [`monitora_campsav_alvo_global_v2.7.1.R`](monitora_campsav_alvo_global_v2.7.1.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.7.1/`](releases/v2.7.1/)
- Notas da versão: [`RELEASE_NOTES_v2.7.1.md`](RELEASE_NOTES_v2.7.1.md)
- Release no GitHub: [v2.7.1](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.7.1)
...
- Auditoria de dependências condicionais sensível à versão do XLSForm: hábito de samambaia é obrigatório a partir de 2025 e não produz falso positivo para registros históricos.
- Relatório de normalização de CPF cobre todas as ocorrências inválidas detectadas na entrada, inclusive quando a linha é posteriormente removida por exclusão auditável de coleta.
- Preservação integral das entregas estruturais da v2.7.0, sem alteração do painel, da fila, dos atributos editáveis ou das rotinas semânticas.
...
2. Copie `monitora_campsav_alvo_global_v2.7.1.R` para a raiz.
...
5. Execute no RStudio ou com `Rscript monitora_campsav_alvo_global_v2.7.1.R`.
6. Confira os produtos em `output/`, a documentação em `docs/` e a trilha técnica em `log/`.

## Modos de execução

A v2.7.1 preserva os 13 modos públicos:
...
- `monitora_campsav_alvo_global_v2.7.1.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.7.1.md`: notas da versão atual.
- `GUIA_USUARIO_v2.7.1.md`: roteiro operacional resumido.
- `release_assets/v2.7.1/`: conjunto mínimo de artefatos da release.
- `releases/v2.7.1/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.7.1. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.7.1. Acesso em: DD mês AAAA.
```
