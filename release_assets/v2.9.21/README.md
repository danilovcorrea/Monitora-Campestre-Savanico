...
- Versão: `v2.9.21`
- Script principal: [`monitora_campsav_alvo_global_v2.9.21.R`](monitora_campsav_alvo_global_v2.9.21.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.21/`](releases/v2.9.21/)
- Notas da versão: [`RELEASE_NOTES_v2.9.21.md`](RELEASE_NOTES_v2.9.21.md)
- Release no GitHub: [v2.9.21](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.21)
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.18. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.18. Acesso em: DD mês AAAA.
```
