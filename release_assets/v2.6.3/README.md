...
**Script principal:** [`monitora_campsav_alvo_global_v2.6.3.R`](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/blob/main/monitora_campsav_alvo_global_v2.6.3.R)

## Finalidade

O script lê, padroniza, audita, deduplica, corrige e analisa registros exportados do SISMONITORA para campanhas amostrais do alvo global Plantas Herbáceas e Lenhosas. Também pode abrir painel Shiny para correções assistidas, validar espacialmente COLETAS, gerar relatórios de apoio, estatísticas, gráficos, KMLs e produtos compatíveis com o contrato XLSForm/SISMONITORA quando habilitado.
...
- `v2.6.3`: v2.6.3 com painel operacional, replay semântico, produtos finais, manual e relatório consolidado pós-correção documental.
...
CBC/ICMBio-MMA. 2026. *Script de tratamento, validação e análise de dados do Alvo Global Plantas Herbáceas e Lenhosas, Nativas e Exóticas do Componente Campestre Savânico do Programa Monitora*. Versão `v2.6.3`.

Repositório GitHub: https://github.com/danilovcorrea/Monitora-Campestre-Savanico
