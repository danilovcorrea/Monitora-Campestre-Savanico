# Guia do usuário — v3.0.1

O arquivo `monitora_campsav_alvo_global_v3.0.1.R` executa a curadoria e gera os
...
O [manual completo em PDF](manual_usuario/manual_usuario_v3.0.1.pdf) e a
[versão navegável em HTML](manual_usuario/manual_usuario_v3.0.1.html) explicam
