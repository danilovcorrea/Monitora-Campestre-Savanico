...
- Versão: `v2.7.0`
- Script principal: [`monitora_campsav_alvo_global_v2.7.0.R`](monitora_campsav_alvo_global_v2.7.0.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.7.0/`](releases/v2.7.0/)
- Notas da versão: [`RELEASE_NOTES_v2.7.0.md`](RELEASE_NOTES_v2.7.0.md)
- Release no GitHub: [v2.7.0](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.7.0)
...
2. Copie `monitora_campsav_alvo_global_v2.7.0.R` para a raiz.
...
5. Execute no RStudio ou com `Rscript monitora_campsav_alvo_global_v2.7.0.R`.
6. Confira os produtos em `output/`, a documentação em `docs/` e a trilha técnica em `log/`.

## Modos de execução

A v2.7.0 preserva os 13 modos públicos:
...
- `monitora_campsav_alvo_global_v2.7.0.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.7.0.md`: notas da versão atual.
- `GUIA_USUARIO_v2.7.0.md`: roteiro operacional resumido.
- `release_assets/v2.7.0/`: conjunto mínimo de artefatos da release.
- `releases/v2.7.0/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.7.0. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.7.0. Acesso em: DD mês AAAA.
```
