...
- Versão: `v2.9.24`
- Script principal: [`monitora_campsav_alvo_global_v2.9.24.R`](monitora_campsav_alvo_global_v2.9.24.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.24/`](releases/v2.9.24/)
- Notas da versão: [`RELEASE_NOTES_v2.9.24.md`](RELEASE_NOTES_v2.9.24.md)
- Release no GitHub: [v2.9.24](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.24)
...
- `monitora_campsav_alvo_global_v2.9.24.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.24.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.24.md`: roteiro operacional resumido.
- `release_assets/v2.9.24/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.24/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.24. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.24. Acesso em: DD mês AAAA.
```
