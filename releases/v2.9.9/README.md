...
- Versão: `v2.9.9`
- Script principal: [`monitora_campsav_alvo_global_v2.9.9.R`](monitora_campsav_alvo_global_v2.9.9.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.9/`](releases/v2.9.9/)
- Notas da versão: [`RELEASE_NOTES_v2.9.9.md`](RELEASE_NOTES_v2.9.9.md)
- Release no GitHub: [v2.9.9](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.9)
...
Os padrões da v2.9.9 representam a continuidade incremental integral usada pela
...
2. Copie `monitora_campsav_alvo_global_v2.9.9.R` para a raiz.
...
5. Execute no RStudio ou com `Rscript monitora_campsav_alvo_global_v2.9.9.R`.
...
A v2.9.9 preserva os 13 modos públicos:
...
- `monitora_campsav_alvo_global_v2.9.9.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.9.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.9.md`: roteiro operacional resumido.
- `release_assets/v2.9.9/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.9/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.9. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.9. Acesso em: DD mês AAAA.
```
