# Monitora Campestre-Savânico — v3.0.3

Build: `v3.0.3-20260924-r01`.

Este pacote contém o [script autônomo](monitora_campsav_alvo_global_v3.0.3.R),
[guia operacional](GUIA_USUARIO_v3.0.3.md), [notas da versão](RELEASE_NOTES_v3.0.3.md)
e manual em [HTML](manual_usuario/manual_usuario_v3.0.3.html) e
[PDF](manual_usuario/manual_usuario_v3.0.3.pdf). As somas de verificação estão em
