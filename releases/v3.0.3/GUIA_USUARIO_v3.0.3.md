# Guia do usuário — v3.0.3

O arquivo `monitora_campsav_alvo_global_v3.0.3.R` executa a curadoria e gera os
...
O [manual completo em PDF](manual_usuario/manual_usuario_v3.0.3.pdf) e a
[versão navegável em HTML](manual_usuario/manual_usuario_v3.0.3.html) explicam
...
e auditorias em `03_aud`; a identificação da UC permanece nos documentos e
