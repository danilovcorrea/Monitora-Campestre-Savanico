...
- Versão: `v2.9.10`
- Script principal: [`monitora_campsav_alvo_global_v2.9.10.R`](monitora_campsav_alvo_global_v2.9.10.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.10/`](releases/v2.9.10/)
- Notas da versão: [`RELEASE_NOTES_v2.9.10.md`](RELEASE_NOTES_v2.9.10.md)
- Release no GitHub: [v2.9.10](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.10)
...
## Destaques da v2.9.10

- Corrige a geração de figuras dos relatórios analíticos em diretórios longos
  no Windows, sem alterar os nomes quando o caminho já é seguro.
- Nomes compactos são determinísticos e contêm hash, evitando colisões; os
  índices e relatórios usam automaticamente o nome efetivamente criado.
- Contraprova real da EEC, em caminho mais longo que o caso original, gerou 44
  resultados inferenciais e relatórios sintético e detalhado em Rmd, Markdown,
  HTML, DOCX e PDF, todos aprovados pelos gates.

### Preservado da v2.9.9
...
Os padrões da v2.9.10 representam a continuidade incremental integral usada pela
...
2. Copie `monitora_campsav_alvo_global_v2.9.10.R` para a raiz.
...
5. Execute no RStudio ou com `Rscript monitora_campsav_alvo_global_v2.9.10.R`.
...
A v2.9.10 preserva os 13 modos públicos:
...
- `monitora_campsav_alvo_global_v2.9.10.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.10.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.10.md`: roteiro operacional resumido.
- `release_assets/v2.9.10/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.10/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.10. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.10. Acesso em: DD mês AAAA.
```
