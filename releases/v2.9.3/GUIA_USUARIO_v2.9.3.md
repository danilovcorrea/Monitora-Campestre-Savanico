# Guia do usuário — v2.9.3

## Preparação

1. Crie uma pasta de execução vazia.
2. Copie `monitora_campsav_alvo_global_v2.9.3.R` para essa pasta.
...
**Source** normalmente. A v2.9.3 preserva o encapsulamento interno que evita a
...
exóticas, secas ou mortas, material botânico e evidências priorizadas. Os
produtos ficam em `output/08_relatorios_analiticos/`.
