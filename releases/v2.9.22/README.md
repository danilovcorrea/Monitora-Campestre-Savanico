...
- Versão: `v2.9.22`
- Script principal: [`monitora_campsav_alvo_global_v2.9.22.R`](monitora_campsav_alvo_global_v2.9.22.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.22/`](releases/v2.9.22/)
- Notas da versão: [`RELEASE_NOTES_v2.9.22.md`](RELEASE_NOTES_v2.9.22.md)
- Release no GitHub: [v2.9.22](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.22)
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.22. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.22. Acesso em: DD mês AAAA.
```
