# Guia do usuário — v2.9.1

## Preparação

1. Crie uma pasta de execução vazia.
2. Copie `monitora_campsav_alvo_global_v2.9.1.R` para essa pasta.
...
**Source** normalmente. A v2.9.1 preserva a solução que evita o atraso causado por `Source with Echo`
