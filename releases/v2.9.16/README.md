...
- Versão: `v2.9.16`
- Script principal: [`monitora_campsav_alvo_global_v2.9.16.R`](monitora_campsav_alvo_global_v2.9.16.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.16/`](releases/v2.9.16/)
- Notas da versão: [`RELEASE_NOTES_v2.9.16.md`](RELEASE_NOTES_v2.9.16.md)
- Release no GitHub: [v2.9.16](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.16)
...
2. Copie `monitora_campsav_alvo_global_v2.9.16.R` para a raiz.
...
5. Execute no RStudio ou com `Rscript monitora_campsav_alvo_global_v2.9.16.R`.
...
A v2.9.16 preserva os 13 modos públicos:
...
- `monitora_campsav_alvo_global_v2.9.16.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.16.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.16.md`: roteiro operacional resumido.
- `release_assets/v2.9.16/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.16/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.16. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.16. Acesso em: DD mês AAAA.
```
