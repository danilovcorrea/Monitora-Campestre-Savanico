...
- Versão: `v2.9.20`
- Script principal: [`monitora_campsav_alvo_global_v2.9.20.R`](monitora_campsav_alvo_global_v2.9.20.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.20/`](releases/v2.9.20/)
- Notas da versão: [`RELEASE_NOTES_v2.9.20.md`](RELEASE_NOTES_v2.9.20.md)
- Release no GitHub: [v2.9.20](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.20)
...
- `monitora_campsav_alvo_global_v2.9.18.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.18.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.18.md`: roteiro operacional resumido.
- `release_assets/v2.9.18/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.18/`: cópia congelada da versão.
