...
- Versão: `v2.9.12`
- Script principal: [`monitora_campsav_alvo_global_v2.9.12.R`](monitora_campsav_alvo_global_v2.9.12.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.12/`](releases/v2.9.12/)
- Notas da versão: [`RELEASE_NOTES_v2.9.12.md`](RELEASE_NOTES_v2.9.12.md)
- Release no GitHub: [v2.9.12](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.12)
...
## Destaques da v2.9.12

- O mapa Sentinel-2 representa o limite oficial da UC no mapa principal somente
  quando o contorno intercepta a moldura na escala das UAs. O limite permanece
  no localizador quando não está visível no mapa principal.
- Moldura e coordenadas passam a usar a mesma largura editorial da faixa
  inferior com localizador, legenda, informações e marcas, sem deformar a
  imagem orbital ou deslocar as UAs.
- O botão geral **Limpar filtros** passa a reiniciar filtros, campos
  transitórios, buscas e seleções de todas as abas do painel.
- Responsável, correções, operações espaciais, justificativas, históricos e
  auditorias permanecem preservados durante a limpeza.
- O botão **Limpar filtros espaciais** continua restrito ao módulo espacial.
- O contrato automatizado inventaria os 74 controles editáveis e impede que
  novos campos fiquem silenciosamente fora da limpeza.

### Preservado da v2.9.11
...
Os padrões da v2.9.12 representam a continuidade incremental integral usada pela
...
2. Copie `monitora_campsav_alvo_global_v2.9.12.R` para a raiz.
...
5. Execute no RStudio ou com `Rscript monitora_campsav_alvo_global_v2.9.12.R`.
...
A v2.9.12 preserva os 13 modos públicos:
...
- `monitora_campsav_alvo_global_v2.9.12.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.12.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.12.md`: roteiro operacional resumido.
- `release_assets/v2.9.12/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.12/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.12. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.12. Acesso em: DD mês AAAA.
```
