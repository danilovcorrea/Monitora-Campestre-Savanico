...
- Versão: `v2.9.23`
- Script principal: [`monitora_campsav_alvo_global_v2.9.23.R`](monitora_campsav_alvo_global_v2.9.23.R)
- Script canônico: [`monitora_campsav_alvo_global.R`](monitora_campsav_alvo_global.R)
- Cópia congelada: [`releases/v2.9.23/`](releases/v2.9.23/)
- Notas da versão: [`RELEASE_NOTES_v2.9.23.md`](RELEASE_NOTES_v2.9.23.md)
- Release no GitHub: [v2.9.23](https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.23)
...
- `monitora_campsav_alvo_global_v2.9.21.R`: script versionado atual.
...
- `RELEASE_NOTES_v2.9.21.md`: notas da versão atual.
- `GUIA_USUARIO_v2.9.21.md`: roteiro operacional resumido.
- `release_assets/v2.9.21/`: conjunto mínimo de artefatos da release.
- `releases/v2.9.21/`: cópia congelada da versão.
...
```text
CORRÊA, Danilo V. Monitora Campestre-Savânico — Alvo Global. Versão v2.9.23. GitHub, 2026. Disponível em: https://github.com/danilovcorrea/Monitora-Campestre-Savanico/releases/tag/v2.9.23. Acesso em: DD mês AAAA.
```
