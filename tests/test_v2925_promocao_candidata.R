...
if (length(args) != 2L) stop("Uso: Rscript test_v2925_promocao_candidata.R <candidata.R> <publica.R>")
...
cat("TEST_V2925_PROMOCAO_CANDIDATA_OK; AST_IDENTICA_EXCETO_IDENTIFICADORES\n")
