...
resultado <- list(
  ...
  v295 = simular_source_com_eco(candidato)
)

stopifnot(
  resultado$v291$expressoes_externas == 1L,
  resultado$v295$expressoes_externas == 1L,
  resultado$v291$eco_bytes <= 512,
  resultado$v295$eco_bytes <= 512,
  identical(resultado$v291$eco_bytes, resultado$v295$eco_bytes)
)
...
cat("TEST_V295_INICIALIZACAO_RSTUDIO_OK\n")
