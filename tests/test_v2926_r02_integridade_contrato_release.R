...
assert(identical(inicio_congelado(linhas_c), inicio_congelado(linhas_b)),
  "A inicialização congelada do RStudio divergiu da v2.9.26 pública.")
...
assert(identical(payload_c, payload_b) && identical(hex_c, hex_b),
  "O código que materializa o contrato XLSForm embutido divergiu da v2.9.26 pública.")
...
assert(
  ...
  "O contrato XLSForm materializado divergiu da v2.9.26 pública."
)
