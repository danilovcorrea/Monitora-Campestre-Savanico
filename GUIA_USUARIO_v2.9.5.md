# Guia do usuário — v2.9.5

## Preparação

1. Crie uma pasta de execução vazia.
2. Copie `monitora_campsav_alvo_global_v2.9.5.R` para essa pasta.
...
**Source** normalmente. A v2.9.5 restaura a arquitetura homologada na v2.9.1:
